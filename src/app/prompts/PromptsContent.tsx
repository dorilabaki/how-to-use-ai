  ...
  return (
    ...
    >
      <div className="flex items-start justify-between gap-4 mb-4">
        ...
        <button
          onClick={handleCopy}
          aria-label={copied ? 'Copied to clipboard' : `Copy "${prompt.title}" prompt`}
        ...
        >
          {copied ? (
            <>
              <svg className="w-4 h-4 inline mr-1" aria-hidden="true" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor">
  ...
  return (
    <>
      <Section className="pt-24">
        ...
        {/* Category Filter */}
        <div className="flex flex-wrap justify-center gap-2 mb-12" role="group" aria-label="Filter prompts by category">
          <button
        ...
        <div className="max-w-3xl mx-auto text-center">
          ...
          <div className="grid md:grid-cols-3 gap-6 text-left mt-8">
            <div className="p-4 bg-dark-800 border border-dark-700 rounded-xl">
              <div className="w-8 h-8 rounded-lg bg-primary-500/10 flex items-center justify-center text-primary-400 mb-3" aria-hidden="true">
                1
              </div>
